...
*/
        ...
        $toolpath = "/server/www/foltia" ; //「php」ディレクトリがあるパス
		$recfolderpath = '/recorded';	//録画ファイルの保存先のパス。
		$httpmediamappath = '/foltia/recorded'; //ブラウザから見える録画ファイルのある位置。
		$recunits = 2;					//搭載アナログキャプチャカードチャンネル数
