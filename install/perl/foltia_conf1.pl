...
#config section
$toolpath = '/server/www/foltia'; #「perl」ディレクトリがあるPATH
$recunits = '0';					#搭載エンコーダの数
$recfolderpath = '/media/recorded';		#録画ファイルを置くPATH
$uhfbandtype = 0; # CATVなら1 UHF帯なら0 : 0=ntsc-bcast-jp 1=ntsc-cable-jp
